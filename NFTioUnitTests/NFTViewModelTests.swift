...
final class NFTViewModelTests: XCTestCase {
    ...
    func testSetSelectedCollection() {
        let collection = NFTCollection(id: "2", name: "Bored Ape Yacht Club", contractAddress: "", numberOfItems: 1, createdAt: Date(), category: Category(id: "1", name: .art, imageUrl: ""), totalVolume: 1, floorPrice: 1, owners: 1)
    ...
    func testFilteredNFTItemsOnCollection() {
        ...
        XCTAssertEqual(filteredItems[0].collection.name, "Bored Ape Yacht Club")
    }
